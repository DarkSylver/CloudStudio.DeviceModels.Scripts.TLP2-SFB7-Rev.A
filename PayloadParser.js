function parseUplink(device, payload) {
    ...
    if (decodedMessage.bleDataList != null && Array.isArray(decodedMessage.bleDataList)) {
        for (var i = 0; i < decodedMessage.bleDataList.length; i++) {
            ...
            if (ble && ble.mac === "d35b8cac1c50" && ble.temp != null) {
            ...
            if (ble && ble.mac === "d35b8cac1c50" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "d35b8cac1c50" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "d35b8cac1c50" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "d35b8cac1c50" && ble.rssi != null) {
            ...
            if (ble && ble.mac === "faeccd2ecb6e" && ble.temp != null) {
            ...
            if (ble && ble.mac === "faeccd2ecb6e" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "faeccd2ecb6e" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "faeccd2ecb6e" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "faeccd2ecb6e" && ble.rssi != null) {
